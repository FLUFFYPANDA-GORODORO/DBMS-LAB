...
public class Quiz extends JFrame implements ActionListener {
    ...
    // String query ="select * from ?";
        try{
            ...
            System.out.println( g + "Hello Noob");
            
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setString(1, g);
            ResultSet rs=pstmt.executeQuery();
                
            // ResultSet rs=stmt.executeQuery("select * from c order by rand() limit 10");  
...
//     }
 ...
 // lf = new JButton("50-50 Lifeline");
        // lf.setBounds(1100,610,200,40);
        // lf.setFont(new Font("Tahoma",Font.PLAIN,20));
        // lf.setBackground(new Color(30,144,255));
